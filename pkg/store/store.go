...
func (s *Store) Migrate() (int, error) {
	migrations := &migrate.MemoryMigrationSource{
		Migrations: []*migrate.Migration{
			&migrate.Migration{
				Id:   "1",
				Up:   []string{"CREATE TABLE `rover_sc_genres` (`id` INT NOT NULL AUTO_INCREMENT, `name` VARCHAR CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, UNIQUE KEY `id` (`id`) USING BTREE) ENGINE=InnoDB;)"},
